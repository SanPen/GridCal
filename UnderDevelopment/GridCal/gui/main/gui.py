...
#
# Created: Mon Oct 31 13:18:14 2016
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout.addWidget(self.result_element_selection_listView, 1, 0, 1, 3)
        self.plot_pushButton = QtWidgets.QPushButton(self.frame_9)
        self.plot_pushButton.setObjectName("plot_pushButton")
        self.gridLayout.addWidget(self.plot_pushButton, 2, 2, 1, 1)
...
"last solution"))
        ...
        self.radioButton.setText(_translate("mainWindow", "Use alpha target from current situation"))
        self.label_18.setText(_translate("mainWindow", "Alpha (Increase the power \'alpha\' times)"))
        self.radioButton_2.setText(_translate("mainWindow", "Use departure and target points from time series"))
