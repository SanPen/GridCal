...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.cascade_step_by_step_checkBox = QtWidgets.QCheckBox(self.frame_16)
        self.cascade_step_by_step_checkBox.setChecked(False)
        self.cascade_step_by_step_checkBox.setObjectName("cascade_step_by_step_checkBox")
        self.verticalLayout_13.addWidget(self.cascade_step_by_step_checkBox)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/file/continuation_power_flow.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/file/latin_hypercube2.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLatin_Hypercube_Sampling.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/file/blackout.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBlackout_cascade.setIcon(icon21)
...
"last solution"))
        ...
        self.cascade_step_by_step_checkBox.setText(_translate("mainWindow", "Step by step?"))
