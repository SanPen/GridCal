...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icons/white_icons/grid_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Icons/white_icons/squares.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Icons/white_icons/save.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.resolution_factor_spinBox = QtWidgets.QSpinBox(self.frame_14)
        ...
        self.verticalLayout_12.addWidget(self.resolution_factor_spinBox)
        self.line_16 = QtWidgets.QFrame(self.frame_14)
        ...
        self.line_17 = QtWidgets.QFrame(self.frame_14)
        ...
        self.branch_rating_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.frame_14)
        ...
        self.verticalLayout_12.addWidget(self.branch_rating_doubleSpinBox)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Icons/white_icons/gear.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout_5.addWidget(self.profile_time_selection_comboBox, 1, 5, 1, 2)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/Icons/white_icons/new.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.new_profiles_structure_pushButton.setIcon(icon9)
        ...
        self.profile_display_pushButton.setIcon(icon6)
        ...
        self.gridLayout_5.addWidget(self.label_10, 0, 5, 1, 3)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/Icons/white_icons/chip.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.TimeEventsTab, icon11, "")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/Icons/white_icons/pic.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.plot_pushButton.setIcon(icon12)
        ...
        self.saveResultsButton.setIcon(icon7)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/Icons/white_icons/bars.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.ResultsTab, icon13, "")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/Icons/white_icons/console.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.console_tab, icon14, "")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/Icons/white_icons/loadc.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_file.setIcon(icon15)
        self.actionOpen_file.setObjectName("actionOpen_file")
        self.actionSave = QtWidgets.QAction(mainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/Icons/white_icons/savec.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/Icons/white_icons/new2c.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew_project.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/Icons/white_icons/pf.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPower_flow.setIcon(icon18)
        self.actionPower_flow.setObjectName("actionPower_flow")
        self.actionPower_Flow_Time_series = QtWidgets.QAction(mainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/Icons/white_icons/pf_ts.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPower_Flow_Time_series.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/Icons/white_icons/plus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBigger_nodes.setIcon(icon20)
        self.actionBigger_nodes.setObjectName("actionBigger_nodes")
        self.actionSmaller_nodes = QtWidgets.QAction(mainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/Icons/white_icons/minus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSmaller_nodes.setIcon(icon21)
        self.actionSmaller_nodes.setObjectName("actionSmaller_nodes")
        self.actionPower_flow_Stochastic = QtWidgets.QAction(mainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/Icons/white_icons/stochastic_power_flow.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPower_flow_Stochastic.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/Icons/white_icons/continuation_power_flow.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionVoltage_stability.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/Icons/white_icons/resize.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCenter_view.setIcon(icon24)
        self.actionCenter_view.setObjectName("actionCenter_view")
        self.actionShort_Circuit = QtWidgets.QAction(mainWindow)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/Icons/white_icons/short_circuit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShort_Circuit.setIcon(icon25)
        self.actionShort_Circuit.setObjectName("actionShort_Circuit")
        self.actionAutoatic_layout = QtWidgets.QAction(mainWindow)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/Icons/white_icons/automatic_layout.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/Icons/white_icons/latin_hypercube2.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLatin_Hypercube_Sampling.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/Icons/white_icons/blackout.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBlackout_cascade.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/file/run_cascade.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRun_complete_cascade.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/file/run_cascade_step.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRun_cascade_step.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/white/white_icons/copy.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopy_cascade_state_to_main_grid.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/Icons/white_icons/dcopf.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOPF.setIcon(icon32)
        self.actionOPF.setObjectName("actionOPF")
        self.actionOPF_time_series = QtWidgets.QAction(mainWindow)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/Icons/white_icons/dcopf_ts.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOPF_time_series.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/Icons/white_icons/detect_tr.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDetect_transformers.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/Icons/white_icons/rate_br.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAuto_rate_branches.setIcon(icon35)
...
"last solution"))
        ...
        self.label_33.setText(_translate("mainWindow", "Graphics"))
