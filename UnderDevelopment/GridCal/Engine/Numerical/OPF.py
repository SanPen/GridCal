...
class DcOpf:
    ...
    def solve(self):
        ...
        print("Cost =", value(self.problem.objective), '€')
...
if __name__ == '__main__':
    ...
    grid.load_file('/home/santi/Documentos/GitHub/GridCal/Grids_and_profiles/grids/lynn5buspv.xlsx')
    # grid.load_file('IEEE30.xlsx')
    # grid.load_file('/home/santi/Documentos/GitHub/GridCal/Grids_and_profiles/grids/Illinois200Bus.xlsx')

    grid.compile()

    for circ in grid.circuits:
