...
from GridCal.ThirdParty.qdarktheme import __version__, _os_appearance, _resources
from GridCal.ThirdParty.qdarktheme._template import filter
from GridCal.ThirdParty.qdarktheme._template.engine import Template
from GridCal.ThirdParty.qdarktheme._util import get_cash_root_path, get_logger
...
def load_stylesheet(
    ...
    *,
    ...
    try:
        from GridCal.ThirdParty.qdarktheme.qtpy.QtCore import QCoreApplication
