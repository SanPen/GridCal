...
if sys.platform == "darwin":
    if macos_supported_version():
        from GridCal.ThirdParty.darkdetect._mac_detect import *
    else:
        from GridCal.ThirdParty.darkdetect._dummy import *
    ...
    if winver >= 14393:
        from GridCal.ThirdParty.darkdetect._windows_detect import *
    else:
        from GridCal.ThirdParty.darkdetect._dummy import *

elif sys.platform == "linux":
    from GridCal.ThirdParty.darkdetect._linux_detect import *
else:
    from GridCal.ThirdParty.darkdetect._dummy import *
