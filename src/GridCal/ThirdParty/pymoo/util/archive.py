...
from GridCal.ThirdParty.pymoo.core.duplicate import DefaultDuplicateElimination
from GridCal.ThirdParty.pymoo.core.population import Population, merge
...
def default_archive(problem, **kwargs):
    if problem.n_obj == 1:
        ...
        from GridCal.ThirdParty.pymoo.algorithms.moo.sms import LeastHypervolumeContributionSurvival
        ...
        from GridCal.ThirdParty.pymoo.algorithms.moo.spea2 import SPEA2Survival
