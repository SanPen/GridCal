...
from GridCal.ThirdParty.pymoo.core.algorithm import LoopwiseAlgorithm
...
from GridCal.ThirdParty.pymoo.core.variable import Real, get
...
from GridCal.ThirdParty.pymoo.util.reference_direction import default_ref_dirs
...
def default_decomp(problem):
    if problem.n_obj <= 2:
        from GridCal.ThirdParty.pymoo.decomposition.tchebicheff import Tchebicheff
        return Tchebicheff()
    else:
        from GridCal.ThirdParty.pymoo.decomposition.pbi import PBI
        return PBI()
