...
from GridCal.ThirdParty.pymoo.core.individual import calc_cv
...
if __name__ == '__main__':
    ...
    from GridCal.ThirdParty.pymoo.gradient.automatic import AutomaticDifferentiation

    from GridCal.ThirdParty.pymoo.constraints.from_bounds import ConstraintsFromBounds
