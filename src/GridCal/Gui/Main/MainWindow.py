...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon72 = QIcon()
        icon72.addFile(u":/Icons/icons/delete_schematic.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon73 = QIcon()
        icon73.addFile(u":/Icons/icons/record.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon74 = QIcon()
        icon74.addFile(u":/Icons/icons/CataloguePrivate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon75 = QIcon()
        icon75.addFile(u":/Icons/icons/assign_to_profile.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon76 = QIcon()
        icon76.addFile(u":/Icons/icons/add_remedial_action.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        icon77 = QIcon()
        icon77.addFile(u":/Icons/icons/color_grid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.colour_results_pushButton.setIcon(icon77)
        ...
        icon80 = QIcon()
        icon80.addFile(u":/Icons/icons/histogram.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.structure_analysis_pushButton.setIcon(icon80)
        ...
        icon81 = QIcon()
        icon81.addFile(u":/Icons/icons/copy2left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon82 = QIcon()
        icon82.addFile(u":/Icons/icons/plus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.add_object_pushButton.setIcon(icon82)
        ...
        icon83 = QIcon()
        icon83.addFile(u":/Icons/icons/minus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.delete_selected_objects_pushButton.setIcon(icon83)
        ...
        icon84 = QIcon()
        icon84.addFile(u":/Icons/icons/area_transfer.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget_5.addTab(self.tab_2, icon84, "")
        self.tab_16 = QWidget()
        ...
        icon85 = QIcon()
        icon85.addFile(u":/Icons/icons/new (delete).svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.delete_profiles_structure_pushButton.setIcon(icon85)
        ...
        icon86 = QIcon()
        icon86.addFile(u":/Icons/icons/import_profiles.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.edit_profiles_pushButton.setIcon(icon86)
        ...
        icon87 = QIcon()
        icon87.addFile(u":/Icons/icons/import_models.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.edit_profiles_from_models_pushButton.setIcon(icon87)
        ...
        icon88 = QIcon()
        icon88.addFile(u":/Icons/icons/plot.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.plot_time_series_pushButton.setIcon(icon88)
        ...
        icon89 = QIcon()
        icon89.addFile(u":/Icons/icons/copy.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.copy_profile_pushButton.setIcon(icon89)
        ...
        icon90 = QIcon()
        icon90.addFile(u":/Icons/icons/paste.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.paste_profiles_pushButton.setIcon(icon90)
        ...
        icon91 = QIcon()
        icon91.addFile(u":/Icons/icons/copy2right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.set_linear_combination_profile_pushButton.setIcon(icon91)
        ...
        self.profile_add_pushButton.setIcon(icon82)
        ...
        self.profile_subtract_pushButton.setIcon(icon83)
        ...
        icon92 = QIcon()
        icon92.addFile(u":/Icons/icons/multiply.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.profile_multiply_pushButton.setIcon(icon92)
        ...
        icon93 = QIcon()
        icon93.addFile(u":/Icons/icons/divide.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.profile_divide_pushButton.setIcon(icon93)
        ...
        icon94 = QIcon()
        icon94.addFile(u":/Icons/icons/copy2up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.set_profile_value_pushButton.setIcon(icon94)
        ...
        icon95 = QIcon()
        icon95.addFile(u":/Icons/icons/time_series.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget_5.addTab(self.tab_16, icon95, "")
        ...
        icon96 = QIcon()
        icon96.addFile(u":/Icons/icons/calculator.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.compute_simulation_data_pushButton.setIcon(icon96)
        ...
        icon97 = QIcon()
        icon97.addFile(u":/Icons/icons/array.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.copyArraysToNumpyButton.setIcon(icon97)
        ...
        self.plotArraysButton.setIcon(icon88)
        ...
        self.copyArraysButton.setIcon(icon89)
        ...
        icon98 = QIcon()
        icon98.addFile(u":/Icons/icons/spmat.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget_3.addTab(self.compiledArraysTab, icon98, "")
        ...
        icon99 = QIcon()
        icon99.addFile(u":/Icons/icons/edit.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget_3.addTab(self.commentsTab, icon99, "")
        ...
        self.deleteDriverButton.setIcon(icon83)
        ...
        icon100 = QIcon()
        icon100.addFile(u":/Icons/icons/transpose.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.results_traspose_checkBox.setIcon(icon100)
        ...
        icon101 = QIcon()
        icon101.addFile(u":/Icons/icons/cdf.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.results_as_cdf_checkBox.setIcon(icon101)
        ...
        icon102 = QIcon()
        icon102.addFile(u":/Icons/icons/abs.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.results_as_abs_checkBox.setIcon(icon102)
        ...
        icon103 = QIcon()
        icon103.addFile(u":/Icons/icons/stacked_plot.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.stacked_plot_checkBox.setIcon(icon103)
        ...
        self.copy_results_pushButton.setIcon(icon89)
        ...
        self.copy_numpy_button.setIcon(icon97)
        ...
        self.plot_data_pushButton.setIcon(icon88)
        ...
        self.tabWidget_4.addTab(self.tab_7, icon97, "")
        self.tab_14 = QWidget()
        ...
        self.tabWidget.addTab(self.ResultsTab, icon88, "")
        ...
        icon104 = QIcon()
        icon104.addFile(u":/Icons/icons/next.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.runSourceCodeButton.setIcon(icon104)
        ...
        icon105 = QIcon()
        icon105.addFile(u":/Icons/icons/console.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget_2.addTab(self.pythonConsoleTab, icon105, "")
        ...
        self.tabWidget.addTab(self.main_console_tab, icon105, "")
        ...
        self.settings_tabWidget.addTab(self.transfer_tab, icon84, "")
