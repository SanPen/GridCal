...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/Icons/icons/picture.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/Icons/icons/delete_db.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon65 = QIcon()
        icon65.addFile(u":/Icons/icons/uncheck_all.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon66 = QIcon()
        icon66.addFile(u":/Icons/icons/check_all.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon67 = QIcon()
        icon67.addFile(u":/Icons/icons/chip.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon68 = QIcon()
        icon68.addFile(u":/Icons/icons/nodal_capacity.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon69 = QIcon()
        icon69.addFile(u":/Icons/icons/server.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon70 = QIcon()
        icon70.addFile(u":/Icons/icons/delete_schematic.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon71 = QIcon()
        icon71.addFile(u":/Icons/icons/record.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon72 = QIcon()
        icon72.addFile(u":/Icons/icons/CataloguePrivate.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon74 = QIcon()
        icon74.addFile(u":/Icons/icons/color_grid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.colour_results_pushButton.setIcon(icon74)
        ...
        icon75 = QIcon()
        icon75.addFile(u":/Icons/icons/show_color_controls.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_6.addTab(self.tab_3, icon75, "")
        self.tab_4 = QWidget()
        ...
        self.gridLayout.addWidget(self.frame_30, 15, 0, 1, 2)
        ...
        self.label_100.setPalette(palette2)
        ...
        self.gridLayout.addWidget(self.fps_spinBox, 17, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.branch_width_based_on_flow_checkBox, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.resolution_factor_spinBox, 16, 1, 1, 1)

        self.label_150 = QLabel(self.frame_58)
        self.label_150.setObjectName(u"label_150")
        self.label_150.setFont(font2)

        self.gridLayout.addWidget(self.label_150, 17, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_node_size_spinBox, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_branch_size_spinBox, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.min_branch_size_spinBox, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.palette_comboBox, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ask_before_appliying_layout_checkBox, 4, 0, 1, 1)
        ...
        icon76 = QIcon()
        icon76.addFile(u":/Icons/icons/histogram.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.structure_analysis_pushButton.setIcon(icon76)
        ...
        icon80 = QIcon()
        icon80.addFile(u":/Icons/icons/area_transfer.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_5.addTab(self.tab_2, icon80, "")
        self.tab_16 = QWidget()
        ...
        icon81 = QIcon()
        icon81.addFile(u":/Icons/icons/new (delete).svg", QSize(), QIcon.Normal, QIcon.Off)
        self.delete_profiles_structure_pushButton.setIcon(icon81)
        ...
        icon82 = QIcon()
        icon82.addFile(u":/Icons/icons/import_profiles.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.edit_profiles_pushButton.setIcon(icon82)
        ...
        icon83 = QIcon()
        icon83.addFile(u":/Icons/icons/import_models.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.edit_profiles_from_models_pushButton.setIcon(icon83)
        ...
        icon85 = QIcon()
        icon85.addFile(u":/Icons/icons/copy.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.copy_profile_pushButton.setIcon(icon85)
        ...
        icon86 = QIcon()
        icon86.addFile(u":/Icons/icons/paste.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.paste_profiles_pushButton.setIcon(icon86)
        ...
        icon87 = QIcon()
        icon87.addFile(u":/Icons/icons/copy2right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.set_linear_combination_profile_pushButton.setIcon(icon87)
        ...
        icon88 = QIcon()
        icon88.addFile(u":/Icons/icons/multiply.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profile_multiply_pushButton.setIcon(icon88)
        ...
        icon89 = QIcon()
        icon89.addFile(u":/Icons/icons/divide.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profile_divide_pushButton.setIcon(icon89)
        ...
        icon90 = QIcon()
        icon90.addFile(u":/Icons/icons/copy2up.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.set_profile_value_pushButton.setIcon(icon90)
        ...
        icon91 = QIcon()
        icon91.addFile(u":/Icons/icons/time_series.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_5.addTab(self.tab_16, icon91, "")
        ...
        icon92 = QIcon()
        icon92.addFile(u":/Icons/icons/calculator.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.compute_simulation_data_pushButton.setIcon(icon92)
        ...
        icon93 = QIcon()
        icon93.addFile(u":/Icons/icons/array.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.copyArraysToNumpyButton.setIcon(icon93)
        ...
        self.copyArraysButton.setIcon(icon85)
        ...
        icon94 = QIcon()
        icon94.addFile(u":/Icons/icons/spmat.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_3.addTab(self.compiledArraysTab, icon94, "")
        ...
        icon95 = QIcon()
        icon95.addFile(u":/Icons/icons/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_3.addTab(self.commentsTab, icon95, "")
        ...
        icon96 = QIcon()
        icon96.addFile(u":/Icons/icons/transpose.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_traspose_checkBox.setIcon(icon96)
        ...
        icon97 = QIcon()
        icon97.addFile(u":/Icons/icons/cdf.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_as_cdf_checkBox.setIcon(icon97)
        ...
        icon98 = QIcon()
        icon98.addFile(u":/Icons/icons/abs.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_as_abs_checkBox.setIcon(icon98)
        ...
        self.copy_results_pushButton.setIcon(icon85)
        ...
        self.copy_numpy_button.setIcon(icon93)
        ...
        self.tabWidget_4.addTab(self.tab_7, icon93, "")
        self.tab_14 = QWidget()
        ...
        icon99 = QIcon()
        icon99.addFile(u":/Icons/icons/next.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.runSourceCodeButton.setIcon(icon99)
        ...
        icon100 = QIcon()
        icon100.addFile(u":/Icons/icons/console.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_2.addTab(self.pythonConsoleTab, icon100, "")
        ...
        self.tabWidget.addTab(self.main_console_tab, icon100, "")
        ...
        self.settings_tabWidget.addTab(self.transfer_tab, icon80, "")
        ...
        self.label_121.setPalette(palette29)
        ...
        self.line_30.setPalette(palette33)
        ...
        self.gridLayout_11.addWidget(self.raw_export_version_comboBox, 10, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.label_131, 8, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.label_145, 8, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.label_112, 10, 0, 1, 1)
        ...
        self.gridLayout_11.addItem(self.verticalSpacer_20, 11, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.line_33, 9, 0, 1, 2)

        self.label_24 = QLabel(self.frame_77)
        self.label_24.setObjectName(u"label_24")

        self.gridLayout_11.addWidget(self.label_24, 7, 0, 1, 1)
        ...
        self.menuBar.setGeometry(QRect(0, 0, 1196, 24))
        ...
        self.menuImport.addAction(self.actionAdd_custom_catalogue)
        ...
        self.menuDiagrams.addAction(self.actionDelete_from_the_diagram)
