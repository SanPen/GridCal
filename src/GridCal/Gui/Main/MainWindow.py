...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon39 = QIcon()
        icon39.addFile(u":/Icons/icons/area.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon40 = QIcon()
        icon40.addFile(u":/Icons/icons/zone.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon41 = QIcon()
        icon41.addFile(u":/Icons/icons/map.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon51 = QIcon()
        icon51.addFile(u":/Icons/icons/remedial_action.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon62 = QIcon()
        icon62.addFile(u":/Icons/icons/bug.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon64 = QIcon()
        icon64.addFile(u":/Icons/icons/time_series span.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon65 = QIcon()
        icon65.addFile(u":/Icons/icons/time_series set.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon66 = QIcon()
        icon66.addFile(u":/Icons/icons/scale.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon67 = QIcon()
        icon67.addFile(u":/Icons/icons/uncheck_all.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon68 = QIcon()
        icon68.addFile(u":/Icons/icons/check_all.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon69 = QIcon()
        icon69.addFile(u":/Icons/icons/substation.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon70 = QIcon()
        icon70.addFile(u":/Icons/icons/nodal_capacity.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon71 = QIcon()
        icon71.addFile(u":/Icons/icons/server.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon72 = QIcon()
        icon72.addFile(u":/Icons/icons/delete_schematic.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDelete_from_the_diagram.setIcon(icon72)
        ...
        icon73 = QIcon()
        icon73.addFile(u":/Icons/icons/record.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRecord_video.setIcon(icon73)
        ...
        icon74 = QIcon()
        icon74.addFile(u":/Icons/icons/CataloguePrivate.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_custom_catalogue.setIcon(icon74)
        ...
        self.actionExportCatalogue.setIcon(icon74)
        ...
        icon75 = QIcon()
        icon75.addFile(u":/Icons/icons/assign_to_profile.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionConsolidate_diagram_coordinates.setIcon(icon75)
        ...
        icon76 = QIcon()
        icon76.addFile(u":/Icons/icons/add_remedial_action.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_selected_as_remedial_action.setIcon(icon76)
        self.actionDetect_facilities = QAction(mainWindow)
        self.actionDetect_facilities.setObjectName(u"actionDetect_facilities")
        icon77 = QIcon()
        icon77.addFile(u":/Icons/icons/powerplant.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDetect_facilities.setIcon(icon77)
        ...
        icon78 = QIcon()
        icon78.addFile(u":/Icons/icons/show_color_controls.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.gridLayout.addWidget(self.label_113, 7, 0, 1, 1)
        ...
        self.label_149.setPalette(palette1)
        ...
        self.gridLayout.addWidget(self.palette_comboBox, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.min_node_size_spinBox, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.min_branch_size_spinBox, 5, 1, 1, 1)
        ...
        self.arrow_size_size_spinBox = QDoubleSpinBox(self.frame_58)
        self.arrow_size_size_spinBox.setObjectName(u"arrow_size_size_spinBox")
        self.arrow_size_size_spinBox.setFont(font2)
        self.arrow_size_size_spinBox.setDecimals(3)
        self.arrow_size_size_spinBox.setMinimum(0.010000000000000)
        ...
        self.gridLayout.addWidget(self.arrow_size_size_spinBox, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_node_size_spinBox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_branch_size_spinBox, 6, 1, 1, 1)

        self.redraw_pushButton = QPushButton(self.frame_58)
        self.redraw_pushButton.setObjectName(u"redraw_pushButton")

        self.gridLayout.addWidget(self.redraw_pushButton, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.branch_width_based_on_flow_checkBox, 9, 0, 1, 1)
        ...
        icon80 = QIcon()
        icon80.addFile(u":/Icons/icons/color_grid.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon81 = QIcon()
        icon81.addFile(u":/Icons/icons/histogram.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.structure_analysis_pushButton.setIcon(icon81)
        ...
        icon83 = QIcon()
        icon83.addFile(u":/Icons/icons/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.add_object_pushButton.setIcon(icon83)
        ...
        icon84 = QIcon()
        icon84.addFile(u":/Icons/icons/minus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.delete_selected_objects_pushButton.setIcon(icon84)
        ...
        self.tabWidget_5.addTab(self.tab_2, icon85, "")
        self.tab_16 = QWidget()
        ...
        icon86 = QIcon()
        icon86.addFile(u":/Icons/icons/new (delete).svg", QSize(), QIcon.Normal, QIcon.Off)
        self.delete_profiles_structure_pushButton.setIcon(icon86)
        ...
        icon87 = QIcon()
        icon87.addFile(u":/Icons/icons/import_profiles.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.edit_profiles_pushButton.setIcon(icon87)
        ...
        icon88 = QIcon()
        icon88.addFile(u":/Icons/icons/import_models.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.edit_profiles_from_models_pushButton.setIcon(icon88)
        ...
        icon89 = QIcon()
        icon89.addFile(u":/Icons/icons/plot.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.plot_time_series_pushButton.setIcon(icon89)
        ...
        icon90 = QIcon()
        icon90.addFile(u":/Icons/icons/copy.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.copy_profile_pushButton.setIcon(icon90)
        ...
        icon91 = QIcon()
        icon91.addFile(u":/Icons/icons/paste.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.paste_profiles_pushButton.setIcon(icon91)
        ...
        icon92 = QIcon()
        icon92.addFile(u":/Icons/icons/copy2right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.set_linear_combination_profile_pushButton.setIcon(icon92)
        ...
        self.profile_add_pushButton.setIcon(icon83)
        ...
        self.profile_subtract_pushButton.setIcon(icon84)
        ...
        icon93 = QIcon()
        icon93.addFile(u":/Icons/icons/multiply.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profile_multiply_pushButton.setIcon(icon93)
        ...
        icon94 = QIcon()
        icon94.addFile(u":/Icons/icons/divide.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profile_divide_pushButton.setIcon(icon94)
        ...
        icon95 = QIcon()
        icon95.addFile(u":/Icons/icons/copy2up.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.set_profile_value_pushButton.setIcon(icon95)
        ...
        icon96 = QIcon()
        icon96.addFile(u":/Icons/icons/time_series.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_5.addTab(self.tab_16, icon96, "")
        ...
        icon97 = QIcon()
        icon97.addFile(u":/Icons/icons/calculator.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.compute_simulation_data_pushButton.setIcon(icon97)
        ...
        icon98 = QIcon()
        icon98.addFile(u":/Icons/icons/array.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.copyArraysToNumpyButton.setIcon(icon98)
        ...
        self.plotArraysButton.setIcon(icon89)
        ...
        self.copyArraysButton.setIcon(icon90)
        ...
        icon99 = QIcon()
        icon99.addFile(u":/Icons/icons/spmat.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_3.addTab(self.compiledArraysTab, icon99, "")
        ...
        icon100 = QIcon()
        icon100.addFile(u":/Icons/icons/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget_3.addTab(self.commentsTab, icon100, "")
        ...
        self.deleteDriverButton.setIcon(icon84)
        ...
        icon101 = QIcon()
        icon101.addFile(u":/Icons/icons/transpose.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_traspose_checkBox.setIcon(icon101)
        ...
        icon102 = QIcon()
        icon102.addFile(u":/Icons/icons/cdf.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_as_cdf_checkBox.setIcon(icon102)
        ...
        icon103 = QIcon()
        icon103.addFile(u":/Icons/icons/abs.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.results_as_abs_checkBox.setIcon(icon103)
        ...
        icon104 = QIcon()
        icon104.addFile(u":/Icons/icons/stacked_plot.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.stacked_plot_checkBox.setIcon(icon104)
        ...
        self.copy_results_pushButton.setIcon(icon90)
        ...
        self.copy_numpy_button.setIcon(icon98)
        ...
        self.plot_data_pushButton.setIcon(icon89)
        ...
        self.tabWidget_4.addTab(self.tab_7, icon98, "")
        self.tab_14 = QWidget()
        ...
        self.tabWidget.addTab(self.ResultsTab, icon89, "")
        ...
        icon105 = QIcon()
        icon105.addFile(u":/Icons/icons/next.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.runSourceCodeButton.setIcon(icon105)
        ...
        self.consoleFrame.setFrameShape(QFrame.NoFrame)
        self.consoleFrame.setFrameShadow(QFrame.Plain)
        ...
        icon106 = QIcon()
        icon106.addFile(u":/Icons/icons/console.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.tabWidget.addTab(self.main_console_tab, icon106, "")
        ...
        self.settings_tabWidget.addTab(self.transfer_tab, icon85, "")
        ...
        self.gridLayout_11.addWidget(self.label_155, 7, 0, 1, 1)
        ...
        self.label_131.setPalette(palette45)
...
"(mark to ask)", None))
        ...
        self.label_111.setText(QCoreApplication.translate("mainWindow", u"General", None))
