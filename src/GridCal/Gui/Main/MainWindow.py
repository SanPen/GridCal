...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon38 = QIcon()
        icon38.addFile(u":/Icons/icons/pf_ts_cluster.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionClustering_time_series.setIcon(icon38)
        ...
        icon39 = QIcon()
        icon39.addFile(u":/Icons/icons/map.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon40 = QIcon()
        icon40.addFile(u":/Icons/icons/atc.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon41 = QIcon()
        icon41.addFile(u":/Icons/icons/atc_ts.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon42 = QIcon()
        icon42.addFile(u":/Icons/icons/otdf.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon43 = QIcon()
        icon43.addFile(u":/Icons/icons/ntc_opf.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon44 = QIcon()
        icon44.addFile(u":/Icons/icons/stats.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon45 = QIcon()
        icon45.addFile(u":/Icons/icons/atc_ts_clustering.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionATC_clustering.setIcon(icon45)
        self.actionFuse_devices = QAction(mainWindow)
        self.actionFuse_devices.setObjectName(u"actionFuse_devices")
        icon46 = QIcon()
        icon46.addFile(u":/Icons/icons/fusion.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon48 = QIcon()
        icon48.addFile(u":/Icons/icons/ntc_opf_ts.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon49 = QIcon()
        icon49.addFile(u":/Icons/icons/ntc_opf_ts_clustering.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOptimal_NTC_time_series_clustering.setIcon(icon49)
        self.actionre_index_time = QAction(mainWindow)
        self.actionre_index_time.setObjectName(u"actionre_index_time")
        icon50 = QIcon()
        icon50.addFile(u":/Icons/icons/data.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon51 = QIcon()
        icon51.addFile(u":/Icons/icons/gear.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon52 = QIcon()
        icon52.addFile(u":/Icons/icons/contingency_wizzard.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon53 = QIcon()
        icon53.addFile(u":/Icons/icons/add_contingency.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon54 = QIcon()
        icon54.addFile(u":/Icons/icons/investment.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_selected_as_new_investment.setIcon(icon54)
        self.actionZoom_in = QAction(mainWindow)
        self.actionZoom_in.setObjectName(u"actionZoom_in")
        icon55 = QIcon()
        icon55.addFile(u":/Icons/icons/zoom_in.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionZoom_in.setIcon(icon55)
        self.actionZoom_out = QAction(mainWindow)
        self.actionZoom_out.setObjectName(u"actionZoom_out")
        icon56 = QIcon()
        icon56.addFile(u":/Icons/icons/zoom_out.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon57 = QIcon()
        icon57.addFile(u":/Icons/icons/clustering.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon58 = QIcon()
        icon58.addFile(u":/Icons/icons/clustering_use.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon59 = QIcon()
        icon59.addFile(u":/Icons/icons/expansion_planning.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon61 = QIcon()
        icon61.addFile(u":/Icons/icons/map (add).svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon62 = QIcon()
        icon62.addFile(u":/Icons/icons/add_substation.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_substation_diagram.setIcon(icon62)
        ...
        icon63 = QIcon()
        icon63.addFile(u":/Icons/icons/bug.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReport_a_bug.setIcon(icon63)
        ...
        self.actionSearchDiagram.setIcon(icon64)
        ...
        self.actionEdit_simulation_time_limits.setIcon(icon65)
        ...
        self.frame_2 = QFrame(self.diagram_selection_frame)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setFrameShape(QFrame.NoFrame)
        self.frame_2.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_29 = QHBoxLayout(self.frame_2)
        self.horizontalLayout_29.setObjectName(u"horizontalLayout_29")
        self.horizontalLayout_29.setContentsMargins(6, 0, 2, 2)
        ...
        icon67 = QIcon()
        icon67.addFile(u":/Icons/icons/schematicadd_to.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.addToCurrentDiagramButton.setIcon(icon67)
        ...
        icon71 = QIcon()
        icon71.addFile(u":/Icons/icons/copy.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.copyObjectsTableButton.setIcon(icon71)
        ...
        icon72 = QIcon()
        icon72.addFile(u":/Icons/icons/copy2down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.setValueToColumnButton.setIcon(icon72)
        ...
        icon73 = QIcon()
        icon73.addFile(u":/Icons/icons/assign_to_profile.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.assignToProfileButton.setIcon(icon73)
        ...
        self.copy_profile_pushButton.setIcon(icon71)
        ...
        self.copyArraysButton.setIcon(icon71)
        ...
        self.copy_results_pushButton.setIcon(icon71)
        ...
        self.gridLayout_18.addWidget(self.considerContingenciesOpfCheckBox, 5, 0, 1, 1)

        self.save_mip_checkBox = QCheckBox(self.groupBox)
        self.save_mip_checkBox.setObjectName(u"save_mip_checkBox")

        self.gridLayout_18.addWidget(self.save_mip_checkBox, 9, 0, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_132, 4, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.opfMaximizeExcahngeCheckBox, 5, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.skipOpfGenerationLimitsCheckBox, 3, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.opfUnitCommitmentCheckBox, 4, 0, 1, 1)
        ...
        self.label_61.setPalette(palette11)
        ...
        self.settings_tabWidget.addTab(self.tab_12, icon43, "")
        self.tab_6 = QWidget()
        ...
        self.settings_tabWidget.addTab(self.tab_11, icon42, "")
        self.tab = QWidget()
        ...
        self.tabWidget.addTab(self.SettingsTab, icon51, "")
...
"}")
        ...
        self.menuBar.setGeometry(QRect(0, 0, 1351, 22))
...
#if QT_CONFIG(tooltip)
        self.highlight_selection_buses_pushButton.setToolTip(QCoreApplication.translate("mainWindow", u"Highlight the buses of the selected elements.\n"
"For this to work you need to type the desired highlighting property in the search box.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.set_profile_state_button.setToolTip(QCoreApplication.translate("mainWindow", u"Assign the values of the selected time step into the snapshot", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.edit_profiles_pushButton.setToolTip(QCoreApplication.translate("mainWindow", u"Import profiles from data in CSV or Excel files", None))
#endif // QT_CONFIG(tooltip)
        self.edit_profiles_pushButton.setText("")
#if QT_CONFIG(tooltip)
        self.edit_profiles_from_models_pushButton.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p><span style=\" font-weight:700;\">Import profiles from grid models. </span></p><p>This is, load many individual grids in any </p><p>of the supported GridCal formats and </p><p>take the operational data from them,</p><p>apllying them to all the profiles.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.set_linear_combination_profile_pushButton.setToolTip(QCoreApplication.translate("mainWindow", u"Copy the current profile into the profile selected by the drop-down selector", None))
#endif // QT_CONFIG(tooltip)
