...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.actionSCOPF = QAction(mainWindow)
        self.actionSCOPF.setObjectName(u"actionSCOPF")
        icon78 = QIcon()
        icon78.addFile(u":/Icons/icons/scopf.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSCOPF.setIcon(icon78)
        self.actionSCOPF.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionSCOPF_GNN = QAction(mainWindow)
        self.actionSCOPF_GNN.setObjectName(u"actionSCOPF_GNN")
        icon79 = QIcon()
        icon79.addFile(u":/Icons/icons/scopf_gnn.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSCOPF_GNN.setIcon(icon79)
        self.actionSCOPF_GNN.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        ...
        self.scopf_tab = QWidget()
        self.scopf_tab.setObjectName(u"scopf_tab")
        self.gridLayout_81 = QGridLayout(self.scopf_tab)
        self.gridLayout_81.setObjectName(u"gridLayout_81")
        self.label_15 = QLabel(self.scopf_tab)
        self.label_15.setObjectName(u"label_15")
        palette17 = QPalette()
        brush4 = QBrush(QColor(85, 87, 83, 228))
        ...
        self.label_15.setPalette(palette17)
        self.label_15.setFont(font4)

        self.gridLayout_81.addWidget(self.label_15, 0, 4, 1, 1)

        self.label_100 = QLabel(self.scopf_tab)
        self.label_100.setObjectName(u"label_100")
        palette18 = QPalette()
        palette18.setBrush(QPalette.Active, QPalette.WindowText, brush)
        palette18.setBrush(QPalette.Inactive, QPalette.WindowText, brush)
        palette18.setBrush(QPalette.Disabled, QPalette.WindowText, brush1)
        self.label_100.setPalette(palette18)
        ...
        self.gridLayout_81.addWidget(self.label_100, 0, 1, 1, 1)

        self.line_3 = QFrame(self.scopf_tab)
        self.line_3.setObjectName(u"line_3")
        self.line_3.setFrameShape(QFrame.Shape.VLine)
        self.line_3.setFrameShadow(QFrame.Shadow.Sunken)

        self.gridLayout_81.addWidget(self.line_3, 2, 2, 1, 1)

        self.line_6 = QFrame(self.scopf_tab)
        self.line_6.setObjectName(u"line_6")
        self.line_6.setFrameShape(QFrame.Shape.HLine)
        self.line_6.setFrameShadow(QFrame.Shadow.Sunken)

        self.gridLayout_81.addWidget(self.line_6, 1, 3, 1, 2)

        self.label_9 = QLabel(self.scopf_tab)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setMaximumSize(QSize(24, 24))
        self.label_9.setPixmap(QPixmap(u":/Icons/icons/scopf_gnn.svg"))
        self.label_9.setScaledContents(True)

        self.gridLayout_81.addWidget(self.label_9, 0, 3, 1, 1)

        self.label_99 = QLabel(self.scopf_tab)
        self.label_99.setObjectName(u"label_99")
        self.label_99.setMinimumSize(QSize(24, 24))
        self.label_99.setMaximumSize(QSize(24, 24))
        self.label_99.setPixmap(QPixmap(u":/Icons/icons/scopf.svg"))
        self.label_99.setScaledContents(True)

        self.gridLayout_81.addWidget(self.label_99, 0, 0, 1, 1)

        self.gridGroupBox = QGroupBox(self.scopf_tab)
        ...
        self.gridLayout_36.addWidget(self.label_157, 2, 0, 1, 1)

        self.label_156 = QLabel(self.gridGroupBox)
        self.label_156.setObjectName(u"label_156")
        self.label_156.setFont(font1)

        self.gridLayout_36.addWidget(self.label_156, 1, 0, 1, 1)

        self.label_24 = QLabel(self.gridGroupBox)
        ...
        self.gridLayout_36.addItem(self.verticalSpacer_2, 3, 0, 1, 1)


        self.gridLayout_81.addWidget(self.gridGroupBox, 2, 0, 1, 2)

        self.line_18 = QFrame(self.scopf_tab)
        ...
        self.line_18.setPalette(palette19)
        self.line_18.setFrameShadow(QFrame.Shadow.Plain)
        self.line_18.setLineWidth(4)
        self.line_18.setFrameShape(QFrame.Shape.HLine)

        self.gridLayout_81.addWidget(self.line_18, 1, 0, 1, 2)

        self.line_2 = QFrame(self.scopf_tab)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setFrameShape(QFrame.Shape.VLine)
        self.line_2.setFrameShadow(QFrame.Shadow.Sunken)

        self.gridLayout_81.addWidget(self.line_2, 1, 2, 1, 1)

        self.line = QFrame(self.scopf_tab)
        self.line.setObjectName(u"line")
        self.line.setFrameShape(QFrame.Shape.VLine)
        self.line.setFrameShadow(QFrame.Shadow.Sunken)

        self.gridLayout_81.addWidget(self.line, 0, 2, 1, 1)

        self.gridGroupBox_2 = QGroupBox(self.scopf_tab)
        ...
        self.comboBox = QComboBox(self.gridGroupBox_2)
        ...
        self.gridLayout_35.addWidget(self.comboBox, 5, 1, 1, 1)
        ...
        self.doubleSpinBox_3.setValue(0.001000000000000)

        self.gridLayout_35.addWidget(self.doubleSpinBox_3, 1, 1, 1, 1)
        ...
        self.doubleSpinBox_4.setValue(80.000000000000000)

        self.gridLayout_35.addWidget(self.doubleSpinBox_4, 3, 1, 1, 1)
        ...
        self.doubleSpinBox_2.setValue(0.300000000000000)

        self.gridLayout_35.addWidget(self.doubleSpinBox_2, 2, 1, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_35.addItem(self.verticalSpacer_4, 6, 0, 1, 1)

        self.label_164 = QLabel(self.gridGroupBox_2)
        self.label_164.setObjectName(u"label_164")
        self.label_164.setFont(font1)

        self.gridLayout_35.addWidget(self.label_164, 5, 0, 1, 1)
        ...
        self.gridLayout_35.addWidget(self.label_158, 0, 0, 1, 1)

        self.label_162 = QLabel(self.gridGroupBox_2)
        ...
        self.settings_tabWidget.addTab(self.scopf_tab, icon78, "")
        ...
        self.label_64.setPalette(palette21)
        ...
        self.line_27.setPalette(palette22)
        ...
        self.label_96.setPalette(palette23)
        ...
        self.line_32.setPalette(palette24)
        ...
        self.label_140.setPalette(palette25)
        ...
        self.label_95.setPalette(palette27)
        ...
        self.line_25.setPalette(palette29)
        ...
        self.label_121.setPalette(palette31)
        ...
        self.label_79.setPalette(palette36)
        ...
        self.label_47.setPalette(palette37)
        ...
        self.line_10.setPalette(palette39)
        ...
        self.label_85.setPalette(palette42)
        ...
        self.line_8.setPalette(palette43)
        ...
        self.line_33.setPalette(palette46)
        ...
        self.label_134.setPalette(palette49)
...
"}")
        ...
        self.toolBar.addAction(self.actionSCOPF)
        self.toolBar.addSeparator()
        ...
        self.toolBar.addAction(self.actionSCOPF_GNN)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.actionSCOPF.setText(QCoreApplication.translate("mainWindow", u"Security-constrained optimal power flow", None))
#if QT_CONFIG(tooltip)
        self.actionSCOPF.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p><span style=\" font-weight:700;\">Security-constrained optimal power flow</span></p><p>This runs an SCOPF</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.actionSCOPF_GNN.setText(QCoreApplication.translate("mainWindow", u"Neural network for accelerated SCOPF", None))
#if QT_CONFIG(tooltip)
...
"(mark to ask)", None))
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.scopf_tab.setToolTip(QCoreApplication.translate("mainWindow", u"Scopf settings", None))
#endif // QT_CONFIG(tooltip)
        self.label_15.setText(QCoreApplication.translate("mainWindow", u"Accelerated SCOPF with Neural Network", None))
        self.label_100.setText(QCoreApplication.translate("mainWindow", u"Security-Constrained Optimal Power Flow", None))
        self.label_9.setText("")
        self.label_99.setText("")
        self.gridGroupBox.setTitle(QCoreApplication.translate("mainWindow", u"General SCOPF Settings", None))
        self.label_157.setText(QCoreApplication.translate("mainWindow", u"   Max iterations", None))
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("mainWindow", u"Random", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("mainWindow", u"Contingency 0", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("mainWindow", u"Contingency 1", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("mainWindow", u"Contingency 2", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("mainWindow", u"Contingency 3", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("mainWindow", u"Contingency 4", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("mainWindow", u"Contingency 5", None))
        ...
        self.label_164.setText(QCoreApplication.translate("mainWindow", u"   Contingency test case", None))
