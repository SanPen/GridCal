...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon48 = QIcon()
        icon48.addFile(u":/Icons/icons/delete_with_dialogue.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon78 = QIcon()
        icon78.addFile(u":/Icons/icons/down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionReset_coordinates.setIcon(icon78)
        ...
        icon87 = QIcon()
        icon87.addFile(u":/Icons/icons/new (delete_with_dialogue).svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
#if QT_CONFIG(tooltip)
        self.delete_profiles_structure_pushButton.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p><span style=\" font-weight:700;\">Delete profiles</span></p><p>This will delete_with_dialogue all the profiles and leave the snapshot.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.clearSourceCodeButton.setToolTip(QCoreApplication.translate("mainWindow", u"New script, will delete_with_dialogue the existing code.", None))
#endif // QT_CONFIG(tooltip)
