...
class BaseMainGui(QMainWindow):
    ...
    def add_console_vars(self):
        ...
        :return:
        """
        self.console.interpreter.locals["hlp"] = self.print_console_help
        self.console.interpreter.locals["np"] = np
        self.console.interpreter.locals["pd"] = pd
        self.console.interpreter.locals["plt"] = plt
        self.console.interpreter.locals["clc"] = self.clear_console
        self.console.interpreter.locals['app'] = self
        self.console.interpreter.locals['circuit'] = self.circuit
        self.console.interpreter.locals['user_folder'] = get_create_gridcal_folder