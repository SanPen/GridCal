...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.addDeltaButton = QPushButton(self.frame)
        self.addDeltaButton.setObjectName(u"addDeltaButton")

        self.horizontalLayout.addWidget(self.addDeltaButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.addDeltaButton.setText(QCoreApplication.translate("Dialog", u"+", None))
