...
from GridCal.Engine.Core.Devices.enumerations import BranchType, WindingsConnection, BuildStatus
from GridCal.Engine.Core.Devices.editable_device import EditableDevice, DeviceType
from GridCal.Engine.Core.Devices.Branches.transformer import TransformerControlType
