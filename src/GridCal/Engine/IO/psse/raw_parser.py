...
def read_raw(filename, text_func=None,  progress_func=None, logger = Logger()) -> PsseCircuit:
    ...
    meta_data['fixed shunt'] = [grid.fixed_shunts, PSSeFixedShunt, 1]
    meta_data['fixed bus shunt'] = [grid.fixed_shunts, PSSeFixedShunt, 1]
    meta_data['shunt'] = [grid.fixed_shunts, PSSeFixedShunt, 1]
    meta_data['switched shunt'] = [grid.switched_shunts, PSSeSwitchedShunt, 1]
    meta_data['generator'] = [grid.generators, PSSeGenerator, 1]
    meta_data['induction machine'] = [grid.induction_machines, PSSeInductionMachine, 3]
    meta_data['branch'] = [grid.branches, PSSeBranch, 1]
    meta_data['nontransformer branch'] = [grid.branches, PSSeBranch, 1]
    meta_data['system switching device'] = [grid.switches, PSSeSystemSwitchingDevice, 1]
    meta_data['substation'] = [grid.substations, PSSeSubstation, 1]
    meta_data['transformer'] = [grid.transformers, PSSeTransformer, 4]
    meta_data['two-terminal dc'] = [grid.two_terminal_dc_lines, PSSeTwoTerminalDCLine, 3]
    meta_data['two-terminal dc line'] = [grid.two_terminal_dc_lines, PSSeTwoTerminalDCLine, 3]
    meta_data['vsc dc line'] = [grid.vsc_dc_lines, PSSeVscDCLine, 3]
    meta_data['facts device'] = [grid.facts, PSSeFACTS, 1]
    meta_data['facts control device'] = [grid.facts, PSSeFACTS, 1]
    ...
    meta_data['owner'] = [grid.owners, PSSeOwner, 1]
    meta_data['gne'] = [grid.gne, PSSeGneDevice, 5]
