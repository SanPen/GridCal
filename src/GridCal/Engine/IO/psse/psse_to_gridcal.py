...
def get_gridcal_bus(psse_bus: PSSeBus,
...
def get_gridcal_load(psse_load: PSSeLoad, bus: dev.Bus, logger: Logger) -> dev.Load:
    """
...
def get_gridcal_shunt_fixed(psse_elm: PSSeFixedShunt, bus: dev.Bus, logger: Logger):
    """
...
def get_gridcal_shunt_switched(psse_elm: PSSeSwitchedShunt, bus: dev.Bus, logger: Logger):
    """
    Return Newton Load object
    Returns:
        Newton Load object
...
def get_gridcal_generator(psse_elm: PSSeGenerator, logger: Logger) -> dev.Generator:
    """
    Return Newton Load object
    Returns:
        Newton Load object
...
def get_gridcal_transformer(psse_elm: PSSeTransformer,
                            psse_bus_dict, Sbase,
...
def get_gridcal_line(psse_elm: PSSeBranch, psse_bus_dict, Sbase, logger: Logger) -> dev.Line:
    """
...
def get_hvdc_from_vscdc(psse_elm: PSSeVscDCLine, psse_bus_dict, Sbase, logger: Logger) -> dev.HvdcLine:
    """
...
def get_hvdc_from_twotermdc(psse_elm: PSSeTwoTerminalDCLine, psse_bus_dict, Sbase: float,
...
def get_upfc_from_facts(psse_elm: PSSeFACTS, psse_bus_dict, Sbase, logger: Logger) -> dev.UPFC:
    """
    GEt equivalent object
    :param psse_bus_dict:
    :param logger:
