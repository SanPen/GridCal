...
class ACDCTerminal(IdentifiedObject):
    ...
    def __init__(self, rdfid, tpe):
        ...
        self.OperationalLimitSet: GridCal.Engine.IO.cim.cgmes_2_4_15.devices.aggregation.operational_limit_set.OperationalLimitSet = None
        ...
        self.register_property(name='OperationalLimitSet',
                               class_type=GridCal.Engine.IO.cim.cgmes_2_4_15.devices.aggregation.operational_limit_set.OperationalLimitSet,
                               multiplier=UnitMultiplier.none,
                               unit=UnitSymbol.none,
