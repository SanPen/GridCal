...
class BusbarSection(IdentifiedObject):
    ...
    def get_topological_nodes(self):
        ...
        try:
            ...
            return [GridCal.Engine.IO.cim.cgmes_2_4_15.devices.topological_node.TopologicalNode for term in terms]
        except KeyError:
            return list()
    ...
    def get_topological_node(self):
        ...
        try:
            terms = self.references_to_me['Terminal']
            for term in terms:
                return GridCal.Engine.IO.cim.cgmes_2_4_15.devices.topological_node.TopologicalNode
        except KeyError:
            return list()
