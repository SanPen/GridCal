...
class Switch(DiPole, ConductingEquipment):
    ...
    def get_nodes(self):
        ...
        try:
            ...
            if len(terminals) == 2:
                n1 = GridCal.Engine.IO.cim.cgmes_2_4_15.devices.topological_node.TopologicalNode
                n2 = GridCal.Engine.IO.cim.cgmes_2_4_15.devices.topological_node.TopologicalNode
                return n1, n2
            else:
                return None, None
