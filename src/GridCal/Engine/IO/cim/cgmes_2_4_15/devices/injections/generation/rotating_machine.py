...
import GridCal.Engine.IO.cim.cgmes_2_4_15.devices.injections.generation.hydro_pump
from GridCal.Engine.IO.cim.cgmes_2_4_15.devices.injections.regulating_cond_eq import RegulatingCondEq
...
class RotatingMachine(RegulatingCondEq):
    ...
    def __init__(self, rdfid, tpe):
        ...
        self.HydroPump: GridCal.Engine.IO.cim.cgmes_2_4_15.devices.injections.generation.hydro_pump.HydroPump | None = None
        ...
        self.register_property(name='HydroPump',
                               class_type=GridCal.Engine.IO.cim.cgmes_2_4_15.devices.injections.generation.hydro_pump.HydroPump,
                               multiplier=UnitMultiplier.none,
                               unit=UnitSymbol.none,
