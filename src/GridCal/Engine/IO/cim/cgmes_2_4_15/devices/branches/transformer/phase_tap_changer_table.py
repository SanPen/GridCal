...
import GridCal.Engine.IO.cim.cgmes_2_4_15.devices.branches.transformer.phase_tap_changer_tabular
...
class PhaseTapChangerTable(IdentifiedObject):
    ...
    def __init__(self, rdfid, tpe):
        ...
        self.PhaseTapChangerTabular: GridCal.Engine.IO.cim.cgmes_2_4_15.devices.branches.transformer.phase_tap_changer_tabular.PhaseTapChanger = None

        self.register_property(name='PhaseTapChangerTabular',
                               class_type=GridCal.Engine.IO.cim.cgmes_2_4_15.devices.branches.transformer.phase_tap_changer_tabular.PhaseTapChanger,
