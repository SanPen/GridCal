...
U2 = np.array([1.0329 * np.exp(1j * (-121.90*np.pi/180)),
               1.0155 * np.exp(1j * (117.86*np.pi/180))])

U3 = np.array([1.0311 * np.exp(1j * (-121.98*np.pi/180)),
               1.0134 * np.exp(1j * (117.90*np.pi/180))])
...
Sb = (170e3 + 1j * 125e3) / 100e6 * 3

Sbc = (230e3 + 1j * 132e3) / 100e6 * 3
...
print(1/(abs(I2_load[0]) / abs(I2_b)))