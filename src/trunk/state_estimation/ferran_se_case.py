...
# print("\\n")
# print("creo una red sin cargas y les añado medidas, con los valores de pandapower, multiplicados por 1")
# m_circuit2 = CreateGrid(load = False)
# multiplicador=1
# m_circuit2.add_vm_measurement(gce.Devices.VmMeasurement(1.006, 0.004, m_circuit2.buses[0]))
# m_circuit2.add_vm_measurement(gce.Devices.VmMeasurement(0.968, 0.004, m_circuit2.buses[1]))
# m_circuit2.add_pi_measurement(gce.Devices.PiMeasurement(-0.501*multiplicador, 0.010, m_circuit2.buses[1]))
# m_circuit2.add_qi_measurement(gce.Devices.QiMeasurement(-0.286*multiplicador, 0.010, m_circuit2.buses[1]))
# m_circuit2.add_pf_measurement(gce.Devices.PfMeasurement(0.888*multiplicador, 0.008, m_circuit2.lines[0]))
# m_circuit2.add_pf_measurement(gce.Devices.PfMeasurement(1.173*multiplicador, 0.008, m_circuit2.lines[1]))
# m_circuit2.add_qf_measurement(gce.Devices.QfMeasurement(0.568*multiplicador, 0.008, m_circuit2.lines[0]))
# m_circuit2.add_qf_measurement(gce.Devices.QfMeasurement(0.663*multiplicador, 0.008, m_circuit2.lines[1]))
# # Declare the simulation driver and run
# se = gce.StateEstimation(circuit=m_circuit2)
# se.run()
# print('Converged:', se.results.converged, 'error:', se.results.error)
