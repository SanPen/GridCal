...
bus8_block = Block(
    algebraic_eqs=[
        Pline_to_4 + Pline_to_5 + Pline_to_6 + Pline_to_7 + Pline_to_8 + Pl_8,
        Qline_to_4 + Qline_to_5 + Qline_to_6 + Qline_to_7 + Qline_to_8 + Ql_8,
        Pline_to_4 + Pline_to_7,
        Pline_to_4 + Pline_to_8,
        Pline_to_4 + Pline_to_5,
        Pline_to_4 + Pline_to_6,
        Qline_to_4 + Qline_to_7,
        Qline_to_4 + Qline_to_8,
...
bus9_block = Block(
    algebraic_eqs=[
        Pline_from_7 + Pline_from_8 + Pline_to_9 + Pline_to_10 + Pline_to_13,
        Qline_from_7 + Qline_from_8 + Qline_to_9 + Qline_to_10 + Qline_to_13,
        Pline_from_7 + Pline_to_9,
        Pline_from_7 + Pline_to_10,
        Pline_from_7 + Pline_to_13,
        Pline_from_7 + Qline_from_8,
        Qline_from_7 + Qline_to_9,
        Qline_from_7 + Qline_to_10,
        Qline_from_7 + Qline_to_13,
        Qline_from_7 + Qline_from_8
...
bus10_block = Block(
    algebraic_eqs=[
        Pline_to_14 + Pline_from_10 + Pline_from_9,
        Qline_to_14 + Qline_from_10 + Qline_from_9,
        Pline_from_9 + Pline_to_14,
        Pline_from_9 + Pline_from_10,
        Qline_from_9 + Qline_to_14,
        Qline_from_9 + Qline_from_10
    ],
...
vars_mapping = {
    ...
    dline_from_0: 0.414733,
    dline_to_0: 0.659940,
    Vline_from_0: 1.002086,
    Vline_to_0: 1.001550,

    Pline_from_0: -0.000008,
    Qline_from_0:0.000051,
    Pline_to_0: 0.000016,
    Qline_to_0:0.000027,

    dline_from_1: 0.414733,
    dline_to_1: 0.659940,
    Vline_from_1: 1.002086,
    Vline_to_1: 1.001550,

    Pline_from_1: -0.000008,
    Qline_from_1: 0.000051,
    Pline_to_1: 0.000016,
    Qline_to_1: 0.000027,

    dline_from_2: 0.659940,
    dline_to_2: 0.713004,
    Vline_from_2: 1.001550,
    Vline_to_2: 0.999153,

    Pline_from_2: 0.000016,
    Qline_from_2: 0.000027,
    Pline_to_2: -9.999997,
    Qline_to_2: -9.999990,

    dline_from_3: 0.659940,
    dline_to_3:  0.713004,
    Vline_from_3: 1.001550,
    Vline_to_3: 0.999153,

    Pline_from_3: 0.000016,
    Qline_from_3: 0.000027,
    Pline_to_3: -9.999997,
    Qline_to_3: -9.999990,

    dline_from_4: 0.713004,
    dline_to_4: 0.870086,
    Vline_from_4: 0.999153,
    Vline_to_4: 0.999141,

    Pline_from_4: -9.999997,
    Qline_from_4: -9.999990,
    Pline_to_4: -9.999999,
    Qline_to_4: -9.999978,

    dline_from_5: 0.713004,
    dline_to_5: 0.870086,
    Vline_from_5: 0.999153,
    Vline_to_5: 0.999141,

    Pline_from_5: -9.999997,
    Qline_from_5:-9.999990,
    Pline_to_5: -9.999999,
    Qline_to_5: -9.999978,

    dline_from_6: 0.713004,
    dline_to_6:  0.870086,
    Vline_from_6: 0.999153,
    Vline_to_6: 0.999141,

    Pline_from_6:-9.999997,
    Qline_from_6: -9.999990,
    Pline_to_6: -9.999999,
    Qline_to_6: -9.999978,

    dline_from_7: 1.287152,
    dline_to_7: 0.870086,
    Vline_from_7: 1.001528,
    Vline_to_7:  0.999141,

    Pline_from_7: 0.000018,
    Qline_from_7: 0.000025,
    Pline_to_7: -9.999999,
    Qline_to_7: -9.999978,

    dline_from_8: 1.287152,
    dline_to_8: 0.870086,
    Vline_from_8:1.001528,
    Vline_to_8:  0.999141,

    Pline_from_8: 0.000018,
    Qline_from_8: 0.000025,
    Pline_to_8: -9.999999,
    Qline_to_8:  -9.999978,

    dline_from_9: 1.510953,
    dline_to_9: 1.287152,
    Vline_from_9: 1.001528,
    Vline_to_9: 1.002067,

    Pline_from_9: 0.000019,
    Qline_from_9: 0.000008,
    Pline_to_9: 0.000018,
    Qline_to_9: 0.000025,

    dline_from_10: 1.510953,
    dline_to_10: 1.287152,
    Vline_from_10: 1.001528,
    Vline_to_10: 1.002067,

    Pline_from_10:  0.000019,
    Qline_from_10:  0.000008,
    Pline_to_10: 0.000018,
    Qline_to_10: 0.000025,

    dline_from_11: 0.000000,
    dline_to_11: 0.414733,
    Vline_from_11: 1.000000,
    Vline_to_11: 1.002086,

    Pline_from_11:-9.734143,
    Qline_from_11: -0.345113,
    Pline_to_11: -0.000008,
    Qline_to_11: 0.000051,

    dline_from_12: 1.172675,
    dline_to_12: 0.659940,
    Vline_from_12: 1.000000,
    Vline_to_12:1.001550,

    Pline_from_12: 10.000009,
    Qline_from_12: -7.793805,
    Pline_to_12: 0.000016,
    Qline_to_12:0.000027,

    dline_from_13: 1.799368,
    dline_to_13: 1.287152,
    Vline_from_13: 1.000000,
    Vline_to_13: 1.001528,

    Pline_from_13: 10.000013,
    Qline_from_13: -7.762497,
    Pline_to_13: 0.000018,
    Qline_to_13: 0.000025,

    dline_from_14: 2.035684,
    dline_to_14: 1.510953,
    Vline_from_14: 1.000000,
    Vline_to_14: 1.002067,

    Pline_from_14: 10.000011,
    Qline_from_14: -8.518526,
    Pline_to_14: 0.000019,
    Qline_to_14: 0.000008,
