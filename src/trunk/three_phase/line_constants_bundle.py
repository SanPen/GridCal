...
if __name__ == '__main__':
    ...
    line_dict = {
        ...
        'phase_h': [Ya+bundle/2, Ya+bundle/2, Ya-bundle/2, Ya-bundle/2, Yb+bundle/2, Yb+bundle/2, Yb-bundle/2, Yb-bundle/2, Yc+bundle/2, Yc+bundle/2, Yc-bundle/2, Yc-bundle/2],  # Phase conductor heights [m]
        'phase_x': [Xa-bundle/2, Xa+bundle/2, Xa-bundle/2, Xa+bundle/2, Xb-bundle/2, Xb+bundle/2, Xb-bundle/2, Xb+bundle/2, Xc-bundle/2, Xc+bundle/2, Xc-bundle/2, Xc+bundle/2],  # Phase conductor x-axis coordinates [m]
        'phase_cond': ['tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube', 'tube'],  # Phase conductor types ('tube' or 'solid')
        'phase_R': [Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc, Rdc],  # Phase conductor resistances [Ohm/km]
        'phase_r': [r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext, r_ext],  # Phase conductor radi [m]
        'phase_q': [r_int, r_int, r_int, r_int, r_int, r_int, r_int, r_int, r_int, r_int, r_int, r_int],  # Phase conductor inner tube radii [m]
