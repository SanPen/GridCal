...
from GridCal.Gui.Diagrams.DiagramEditorWidget.bus_branch_editor_widget import BusBranchEditorWidget, generate_bus_branch_diagram
...
class BusViewerWidget(QMainWindow):
    ...
    def delete_diagram_element(self, device: ALL_DEV_TYPES):
        """
        Delete element from the diagram
        :param device:
        :return:
        """
        self.grid_editor.delete_diagram_element(device=device)
