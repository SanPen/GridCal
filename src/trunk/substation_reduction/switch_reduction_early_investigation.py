...
# ----------------------------------------------------------------------------------------------------------------------
C_sw_term_mod = sw_states @ C_sw_term
C_br_sw = C_br_term @ C_sw_term_mod.T
C_bus_sw = C_bus_term @ C_sw_term_mod.T
C_br_bus = C_br_sw @ C_bus_sw.T
...
"""
C_buses_joint_by_branches = C_br_bus.T @ C_br_bus
