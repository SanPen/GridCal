...
def get_grid_node_breaker() -> gce.MultiCircuit:
    ...
    grid2.add_connectivity_node(cn3_3)
    grid2.add_connectivity_node(cn3_4)
    ...
    grid2.add_generator(bus=b1, api_obj=g1)
    grid2.add_generator(bus=b2, api_obj=g2)
    grid2.add_generator(bus=None, api_obj=g3, cn=cn3_2)

    # SADR: lines
    grid2.add_line(gce.Line(b1, b2, name='line 1-2', r=0.042, x=0.90, b=0.30, rate=9000))
    grid2.add_line(gce.Line(bus_from=b1, cn_to=cn3_1, name='line 1-3', r=0.065, x=0.62, b=0.45, rate=9000))
    grid2.add_line(gce.Line(cn_from=cn3_4, bus_to=b2, name='line 3-2', r=0.025, x=0.75, b=0.70, rate=50))

    # add loads
    grid2.add_load(bus=b1, api_obj=gce.Load(name='load1', P=147.08, Q=40.00))
    grid2.add_load(bus=b2, api_obj=gce.Load(name='load2', P=147.08, Q=40.00))
    ...
    grid2.process_topology_at(t_idx=None)
