...
class PowerFlow:
    ...
    def run(self, tol=1e-5, max_iter=100, method: PowerFlowMethods=PowerFlowMethods.GaussSeidel, verbose=False):
        ...
        if method == PowerFlowMethods.GaussSeidel:
            ...
            V, converged, err = Numerical.gauss_seidel_power_flow(
                Vbus=data.Vbus,
                Sbus=data.Sbus,
                Ibus=data.Ibus,
                Ybus=data.Ybus,
            ...
            V, converged, err = Numerical.newton_raphson_power_flow(
                Vbus=data.Vbus,
                Sbus=data.Sbus,
                Ibus=data.Ibus,
                Ybus=data.Ybus,
            ...
            V, converged, err = Numerical.gauss_raphson_power_flow(
                Vbus=data.Vbus,
                Sbus=data.Sbus,
                Ibus=data.Ibus,
                Ybus=data.Ybus,
            ...
            V, converged, err = Numerical.z_matrix_power_flow(
                Vbus=data.Vbus,
                Sbus=data.Sbus,
                Ibus=data.Ibus,
                Ybus=data.Ybus,
            ...
            V, converged, err = Numerical.levenberg_marquardt_power_flow(
                Vbus=data.Vbus,
                 Sbus=data.Sbus,
                 Ibus=data.Ibus,
                 Ybus=data.Ybus,
            ...
            V, converged, err = Numerical.linear_ac_power_flow(
                Ybus=data.Ybus,
