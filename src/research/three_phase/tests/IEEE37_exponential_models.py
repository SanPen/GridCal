...
if __name__ == "__main__":
    ...
    # declare loads ####################################################################################################
    b701.add_load(LoadSIY('S701a', S=np.array([140 + 70j, 0, 0]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]), conn=[0, 1],
    ...
    #                       conn_type=Connection.Delta))
    b714.add_load(LoadExp('S714a+b',
                          P0=np.array([17, 21, 0])/1000,
                          Q0=np.array([8, 10, 0])/1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=[0, 1, 2],
                          conn_type=Connection.Delta))
    ...
    b718.add_load(LoadSIY('S718a', Y=np.array([1/(85 + 40j), 0, 0]) / 1000,
                          I=np.array([0, 0, 0]),
                          S=np.array([0, 0, 0]),
                          conn=[0, 1],
                          conn_type=Connection.Delta))
    ...
    #                       conn_type=Connection.Delta))
    b722.add_load(LoadExp('S722b+c',
                          P0=np.array([0, 140, 70])/1000,
                          Q0=np.array([0, 21, 10])/1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=np.array([0, 1, 2]),
    ...
    b724.add_load(LoadSIY('S724b',
                          Y=np.array([0, 1/(42 + 21j), 0]) / 1000,
                          I=np.array([0, 0, 0]),
                          S=np.array([0, 0, 0]),
                          conn=[1, 2],
                          conn_type=Connection.Delta))
    ...
    # b729.add_load(LoadSIY('S729a', S=np.array([42 + 21j, 0, 0]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]),
    #                       conn=[0, 1],
    #                       conn_type=Connection.Delta))

    b729.add_load(LoadExp('S729a',
                          P0=np.array([42, 0, 0]) / 1000,
                          Q0=np.array([21, 0, 0]) / 1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=[0, 1],
    ...
    b730.add_load(LoadSIY('S730c',
                          Y=np.array([0, 0, 1/(85 + 40j)]) / 1000,
                          I=np.array([0, 0, 0]),
                          S=np.array([0, 0, 0]), conn=[0, 2],
                          conn_type=Connection.Delta))

    b731.add_load(LoadSIY('S731b',
                          Y=np.array([0, 1/(85 + 40j), 0]) / 1000,
                          I=np.array([0, 0, 0]), S=np.array([0, 0, 0]),
                          conn=[1, 2],
                          conn_type=Connection.Delta))

    b732.add_load(LoadSIY('S732c', S=np.array([0, 0, 42 + 21j]) / 1000,
                          I=np.array([0, 0, 0]),
                          Y=np.array([0, 0, 0]), conn=[0, 2],
                          conn_type=Connection.Delta))

    # b733.add_load(LoadSIY('S733a', S=np.array([85 + 40j, 0, 0]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]), conn=[0, 1],
    #                       conn_type=Connection.Delta))
    b733.add_load(LoadExp('S733a',
                          P0=np.array([85, 0, 0]) / 1000,
                          Q0=np.array([40, 0, 0]) / 1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=[0, 1],
    ...
    #                       conn_type=Connection.Delta))
    b737.add_load(LoadExp('S737a',
                          P0=np.array([140, 0, 0]) / 1000,
                          Q0=np.array([70, 0, 0]) / 1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=[0, 1],
    ...
    b738.add_load(LoadSIY('S738a', S=np.array([126 + 62j, 0, 0]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]),
                          conn=[0, 1],
                          conn_type=Connection.Delta))

    b740.add_load(LoadSIY('S740c', S=np.array([0, 0, 85 + 40j]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]),
                          conn=[0, 2],
                          conn_type=Connection.Delta))

    # b741.add_load(LoadSIY('S741c', S=np.array([0, 0, 42 + 21j]) / 1000, I=np.array([0, 0, 0]), Y=np.array([0, 0, 0]), conn=[0, 2],
    #                       conn_type=Connection.Delta))
    b741.add_load(LoadExp('b741c',
                          P0=np.array([0, 0, 42]) / 1000,
                          Q0=np.array([0, 0, 21]) / 1000,
                          V0=np.array([1, 1, 1]),
                          exp_p=np.array([1, 1, 1]),
                          exp_q=np.array([2, 2, 2]),
                          conn=[0, 2],
    ...
    b742.add_load(LoadSIY('S742a', Y=np.array([1/(8 + 4j), 0, 0]) / 1000,
                          I=np.array([0, 0, 0]),
                          S=np.array([0, 0, 0]),
                          conn=[0, 1],
                          conn_type=Connection.Delta))

    b742.add_load(LoadSIY('S742b', Y=np.array([0, 1/(85 + 40j), 0]) / 1000,
                          I=np.array([0, 0, 0]),
                          S=np.array([0, 0, 0]),
                          conn=[1, 2],
                          conn_type=Connection.Delta))

    b744.add_load(LoadSIY('S744a', S=np.array([42 + 21j, 0, 0]) / 1000,
                          I=np.array([0, 0, 0]),
                          Y=np.array([0, 0, 0]), conn=[0, 1],
                          conn_type=Connection.Delta))
    ...
    for i in range(len(circuit.buses)):
        print(str(circuit.buses[i]), ':', abs(Vpack[i]), '<', np.angle(Vpack[i], False), 'º p.u. ->\t',
              abs(Vpack[i]) * circuit.buses[i].Vnom, 'kV')
