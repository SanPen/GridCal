...
comment_version_map = {
    35: {
        ...
        "TRANSFORMER DATA": "@!   I,     J,     K,'CKT',CW,CZ,CM,     MAG1,        MAG2,NMETR,               'N A M E',"
                            ...
                            " CX3,  CNXA3\n",
        "AREA INTERCHANGE DATA": "@! I,   ISW,    PDES,     PTOL,    'ARNAME'\n",
        "TWO-TERMINAL DC LINE DATA": "@!  'NAME',   MDC,    RDC,     SETVL,    VSCHD,    VCMOD,    RCOMP,   DELTI,"
        ...
        "VSC DC LINE DATA": "@!  'NAME',   MDC,  RDC,   O1,  F1,    O2,  F2,    O3,  F3,    O4,  F4\n"
                            "@!IBUS,TYPE,MODE,  DCSET,  ACSET,  ALOSS,  BLOSS,MINLOSS,  SMAX,   IMAX,"
                            "   PWF,     MAXQ,   MINQ, \n"
                            "VSREG,NREG, RMPCT\n",
        "TRANSFORMER IMPEDANCE CORRECTION DATA": "@!I,  T1,   Re(F1), Im(F1),   T2,   Re(F2), Im(F2),"
                                                 ...
                                                 "@!      ...\n",
        "MULTI-TERMINAL DC LINE DATA": "@!  'NAME',    NCONV,NDCBS,NDCLN,  MDC, VCONV,   VCMOD, VCONVN\n"
                                       "@!  IB, N,  ANGMX,  ANGMN,   RC,     XC,     EBAS,   TR,    TAP,"
                                       "    TPMX,   TPMN,   TSTP,   SETVL,   "
                                       "DCPF,  MARG,CNVCOD\n"
                                       "@!IDC, IB,AREA,ZONE,   'DCNAME',  IDC2, RGRND,OWNER\n"
                                       "@!IDC,JDC,'DCCKT',MET,  RDC,      LDC\n",
        "MULTI-SECTION LINE GROUP DATA": "@!   I,     J,'ID',MET,DUM1,  DUM2,  DUM3,  DUM4,"
                                         "  DUM5,  DUM6,  DUM7,  DUM8,  DUM9\n",
        "ZONE DATA": "@! I,   'ZONAME'\n",
        "INTER-AREA TRANSFER DATA": "@!ARFROM,ARTO,'TRID',PTRAN\n",
        "OWNER DATA": "@! I,   'OWNAME'\n",
        "FACTS CONTROL DEVICE DATA": "@!  'NAME',         I,     J,MODE,PDES,   QDES,  VSET,   SHMX,   TRMX,   VTMN,"
                                     "   VTMX,   VSMX,    "
                                     "IMX,   LINX,   RMPCT,OWNER,  SET1,    SET2,VSREF, FCREG,NREG,   'MNAME'\n",
        "SWITCHED SHUNT DATA": "@!   I,'ID',MODSW,ADJM,ST, VSWHI,  VSWLO, SWREG,NREG, RMPCT,   'RMIDNT',     BINIT,"
                               "S1,N1,    B1, S2,"
                               "N2,    B2, S3,N3,    B3, S4,N4,    B4, S5,N5,    B5, S6,N6,    B6, S7,N7,"
                               "    B7, S8,N8,    B8\n",
        "GNE DATA": "@!  'NAME',        'MODEL',     NTERM,BUS1...BUSNTERM,NREAL,NINTG,NCHAR\n"
                    "@!ST,OWNER,NMETR\n"
