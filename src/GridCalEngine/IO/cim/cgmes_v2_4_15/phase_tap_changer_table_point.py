...
from GridCalEngine.IO.cim.cgmes_v2_4_15.tap_changer_table_point import TapChangerTablePoint
from GridCalEngine.IO.cim.cgmes_v2_4_15.phase_tap_changer_table import PhaseTapChangerTable


class PhaseTapChangerTablePoint(TapChangerTablePoint):
	def __init__(self, rdfid='', tpe='PhaseTapChangerTablePoint'):
