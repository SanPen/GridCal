...
from GridCalEngine.IO.cim.cgmes_v2_4_15.non_conform_load_group import NonConformLoadGroup


class NonConformLoadSchedule(SeasonDayTypeSchedule):
	def __init__(self, rdfid='', tpe='NonConformLoadSchedule'):
		SeasonDayTypeSchedule.__init__(self, rdfid, tpe)

		self.NonConformLoadGroup: NonConformLoadGroup | None = None
