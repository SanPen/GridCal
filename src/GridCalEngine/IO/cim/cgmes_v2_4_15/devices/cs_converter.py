...
from GridCalEngine.IO.cim.cgmes_v2_4_15.cgmes_enums import cgmesProfile, CsOperatingModeKind, UnitSymbol, CsPpccControlKind
...
class CsConverter(ACDCConverter):
	def __init__(self, rdfid='', tpe='CsConverter'):
		...
		self.register_property(
			...
			description='''Indicates whether the DC pole is operating as an inverter or as a rectifier. CSC control variable used in power flow.''',
			profiles=[]
		)
		self.register_property(
			name='pPccControl',
