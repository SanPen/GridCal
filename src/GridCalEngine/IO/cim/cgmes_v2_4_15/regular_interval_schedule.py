...
from GridCalEngine.IO.cim.cgmes_v2_4_15.basic_interval_schedule import BasicIntervalSchedule
from GridCalEngine.IO.cim.cgmes_v2_4_15.regular_time_point import RegularTimePoint
