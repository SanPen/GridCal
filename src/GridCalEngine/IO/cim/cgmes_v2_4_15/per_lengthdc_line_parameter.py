...
from GridCalEngine.IO.cim.cgmes_v2_4_15.dc_line_segment import DCLineSegment


class PerLengthDCLineParameter(object):
	def __init__(self, rdfid='', tpe='PerLengthDCLineParameter'):
