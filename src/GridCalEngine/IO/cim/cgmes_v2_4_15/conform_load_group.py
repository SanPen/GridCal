...
from GridCalEngine.IO.cim.cgmes_v2_4_15.conform_load import ConformLoad
from GridCalEngine.IO.cim.cgmes_v2_4_15.conform_load_schedule import ConformLoadSchedule
