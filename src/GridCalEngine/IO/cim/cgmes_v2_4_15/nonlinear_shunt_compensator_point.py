...
from GridCalEngine.IO.cim.cgmes_v2_4_15.nonlinear_shunt_compensator import NonlinearShuntCompensator


class NonlinearShuntCompensatorPoint(object):
	def __init__(self, rdfid='', tpe='NonlinearShuntCompensatorPoint'):
