...
class Cgmes_2_4_15_Assets:
    ...
    def __init__(self):
        ...
        self.association_inverse_dict = {
            ...
            'VsConverter': {
                'CapabilityCurve': 'VsConverterDCSides',
                'PccTerminal': 'ConverterDCSides',
            ...
            'MutualCoupling': {
                'Second_Terminal': 'HasSecondMutualCoupling',
                'First_Terminal': 'HasFirstMutualCoupling',
            },
            'SeriesCompensator': {
                'BaseVoltage': 'ConductingEquipment',
                'EquipmentContainer': 'Equipments',
            ...
            'SynchronousMachine': {
                'InitialReactiveCapabilityCurve': 'InitiallyUsedBySynchronousMachines',
            ...
            'DCLineSegment': {
                'PerLengthParameter': 'DCLineSegments',
                'EquipmentContainer': 'Equipments',
            },
            'PetersenCoil': {
                'BaseVoltage': 'ConductingEquipment',
            ...
            'TopologicalIsland': {
                'AngleRefTopologicalNode': 'AngleRefTopologicalIsland',
            ...
            'DCTopologicalIsland': {
                'DCTopologicalNodes': 'DCTopologicalIsland',
            },
            'SvShuntCompensatorSections': {
