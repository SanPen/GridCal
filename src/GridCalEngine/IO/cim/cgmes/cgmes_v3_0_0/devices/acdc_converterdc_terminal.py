...
- For a monopole with two converter terminals use DCPolarityKind ìpositiveî and ìnegativeî.
- For a bi-pole or symmetric monopole with three converter terminals use DCPolarityKind ìpositiveî, ìmiddleî and ìnegativeî.''',
			profiles=[]
		)
