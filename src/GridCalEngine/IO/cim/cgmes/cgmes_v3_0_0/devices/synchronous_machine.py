...
from GridCalEngine.IO.cim.cgmes.cgmes_enums import CgmesProfileType, SynchronousMachineKind, SynchronousMachineOperatingMode, ShortCircuitRotorKind, UnitSymbol
