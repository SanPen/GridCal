...
from GridCalEngine.IO.cim.cgmes.cgmes_enums import cgmesProfile, SynchronousMachineKind, SynchronousMachineOperatingMode, ShortCircuitRotorKind, UnitSymbol
