...
from GridCalEngine.IO.cim.cgmes.cgmes_enums import cgmesProfile, DCPolarityKind, BatteryStateKind, ControlAreaTypeKind, AsynchronousMachineKind, UnitSymbol
