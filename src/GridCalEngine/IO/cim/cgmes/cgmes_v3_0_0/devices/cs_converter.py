...
from GridCalEngine.IO.cim.cgmes.cgmes_enums import cgmesProfile, DCPolarityKind, BatteryStateKind, ControlAreaTypeKind, AsynchronousMachineKind, CsPpccControlKind, CsOperatingModeKind, UnitSymbol
...
class CsConverter(ACDCConverter):
	def __init__(self, rdfid='', tpe='CsConverter'):
		...
		self.register_property(
			...
			description='''Indicates whether the DC pole is operating as an inverter or as a rectifier. It is converterís control variable used in power flow.''',
			profiles=[]
		)
		self.register_property(
			name='pPccControl',
