...
from GridCalEngine.Simulations.ContinuationPowerFlow.continuation_power_flow import continuation_nr, CpfStopAt, \
...
class ContinuationPowerFlowResults(ResultsTemplate):
    ...
    def __init__(self, nval, nbus, nbr, bus_names, branch_names, bus_types):
        ...
        ResultsTemplate.__init__(self,
                                 ...
                                 available_results={ResultTypes.BusResults: [ResultTypes.BusVoltage,
