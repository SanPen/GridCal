...
def vector_sum_srap(p_available3: Vec, sensitivities3: Vec, srap_pmax_mw: float):
    ...
    for i in range(len(p_available3)):
        ...
        # si la suma más el elemento actual es mayor que srap_pmax_mw
            ...
            # salir del bucle
            # break
            return max_srap_power, p_used_unit
    ...
    def is_solvable(self, c_flow: float, rating: float, srap_pmax_mw: float,
        ...
        if c_flow > 0:
            ...
            if len(positive_idx):
                ...
                max_srap_power , p_used_unit  = vector_sum_srap(p_available3, sensitivities3, srap_pmax_mw) #33333333
        ...
        srap_fixing_probability[branch_idx,srap_gen_used3] = p_used_unit
