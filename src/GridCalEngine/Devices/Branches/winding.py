...
from GridCalEngine.Devices.Branches.transformer import TransformerControlType
...
class Winding(BranchParent):
    ...
    def __init__(self, bus_from: Bus = None, bus_to: Bus = None, HV=None, LV=None,
                 ...
                 template: TransformerType = None, contingency_factor=1.0, protection_rating_factor: float = 1.4,
