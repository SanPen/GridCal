...
class Load(LoadParent):
    ...
    def __init__(self, name='Load', idtag=None, code='',
        ...
        self._G1_prof = Profile(default_value=self.G, data_type=float)
        self._G2_prof = Profile(default_value=self.G, data_type=float)
        self._G3_prof = Profile(default_value=self.G, data_type=float)
        self._B_prof = Profile(default_value=self.B, data_type=float)
        self._B1_prof = Profile(default_value=self.B, data_type=float)
        self._B2_prof = Profile(default_value=self.B, data_type=float)
        self._B3_prof = Profile(default_value=self.B, data_type=float)
        self._Ir_prof = Profile(default_value=self.Ir, data_type=float)
        self._Ir1_prof = Profile(default_value=self.Ir, data_type=float)
        self._Ir2_prof = Profile(default_value=self.Ir, data_type=float)
        self._Ir3_prof = Profile(default_value=self.Ir, data_type=float)
        self._Ii_prof = Profile(default_value=self.Ii, data_type=float)
        self._Ii1_prof = Profile(default_value=self.Ii, data_type=float)
        self._Ii2_prof = Profile(default_value=self.Ii, data_type=float)
        self._Ii3_prof = Profile(default_value=self.Ii, data_type=float)
