...
def solver(X0:Vec, NV:int, NE:int, NI:int, f_eval: Callable[[Vec, csc, csc], Tuple[Vec, csc, csc, csc, csc, csc, csc, csc, csc]],
           step_calculator: Callable[[Vec, Vec, int], float], gamma0=10, max_iter=100):
    '''
