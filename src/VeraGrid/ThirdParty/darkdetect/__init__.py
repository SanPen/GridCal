...
if sys.platform == "darwin":
    if macos_supported_version():
        from VeraGrid.ThirdParty.darkdetect._mac_detect import *
    else:
        from VeraGrid.ThirdParty.darkdetect._dummy import *
    ...
    if winver >= 14393:
        from VeraGrid.ThirdParty.darkdetect._windows_detect import *
    else:
        from VeraGrid.ThirdParty.darkdetect._dummy import *

elif sys.platform == "linux":
    from VeraGrid.ThirdParty.darkdetect._linux_detect import *
else:
    from VeraGrid.ThirdParty.darkdetect._dummy import *
