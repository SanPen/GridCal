...
def compare_inputs(grid_newton, grid_gc, tol=1e-6):
    ...
    CheckArr(nc_newton.passive_branch_data.F, nc_gc.passive_branch_data.F, tol, 'BranchData', 'F')
    CheckArr(nc_newton.passive_branch_data.T, nc_gc.passive_branch_data.T, tol, 'BranchData', 'T')
    CheckArr(nc_newton.passive_branch_data.active, nc_gc.passive_branch_data.active, tol, 'BranchData', 'active')
    CheckArr(nc_newton.passive_branch_data.r, nc_gc.passive_branch_data.R, tol, 'BranchData', 'r')
    CheckArr(nc_newton.passive_branch_data.x, nc_gc.passive_branch_data.X, tol, 'BranchData', 'x')
    CheckArr(nc_newton.passive_branch_data.g, nc_gc.passive_branch_data.G, tol, 'BranchData', 'g')
    CheckArr(nc_newton.passive_branch_data.b, nc_gc.passive_branch_data.B, tol, 'BranchData', 'b')
    CheckArr(nc_newton.passive_branch_data.rates, nc_gc.passive_branch_data.rates, tol, 'BranchData', 'rates')
    CheckArr(nc_newton.passive_branch_data.tap_module, nc_gc.passive_branch_data.tap_module, tol, 'BranchData', 'tap_module')
    CheckArr(nc_newton.passive_branch_data.tap_angle, nc_gc.passive_branch_data.tap_angle, tol, 'BranchData', 'tap_angle')

    CheckArr(nc_newton.passive_branch_data.g0, nc_gc.passive_branch_data.G0, tol, 'BranchData', 'g0')
    CheckArr(nc_newton.passive_branch_data.G0sw, nc_gc.passive_branch_data.G0sw, tol, 'BranchData', 'G0sw')
    CheckArr(nc_newton.passive_branch_data.k, nc_gc.passive_branch_data.k, tol, 'BranchData', 'k')
    CheckArr(nc_newton.passive_branch_data.beq, nc_gc.passive_branch_data.Beq, tol, 'BranchData', 'beq')
    CheckArr(nc_newton.passive_branch_data.alpha1, nc_gc.passive_branch_data.alpha1, tol, 'BranchData', 'alpha1')
    CheckArr(nc_newton.passive_branch_data.alpha2, nc_gc.passive_branch_data.alpha2, tol, 'BranchData', 'alpha2')
    CheckArr(nc_newton.passive_branch_data.alpha3, nc_gc.passive_branch_data.alpha3, tol, 'BranchData', 'alpha3')

    CheckArr(nc_newton.passive_branch_data.vtap_f, nc_gc.passive_branch_data.virtual_tap_f, tol, 'BranchData', 'vtap_f')
    CheckArr(nc_newton.passive_branch_data.vtap_t, nc_gc.passive_branch_data.virtual_tap_t, tol, 'BranchData', 'vtap_t')
    ...
    CheckArr(nc_newton.shunt_data.S, nc_gc.shunt_data.Y, tol, 'ShuntData', 'S')
...
def compare_inputs_at(grid_newton, grid_gc, tol=1e-6, t = 0):
    ...
    err_count += CheckArr(nc_newton.passive_branch_data.F, nc_gc.passive_branch_data.F, tol, 'BranchData', 'F')
    err_count += CheckArr(nc_newton.passive_branch_data.T, nc_gc.passive_branch_data.T, tol, 'BranchData', 'T')
    err_count += CheckArr(nc_newton.passive_branch_data.active, nc_gc.passive_branch_data.active, tol, 'BranchData', 'active')
    err_count += CheckArr(nc_newton.passive_branch_data.r, nc_gc.passive_branch_data.R, tol, 'BranchData', 'r')
    err_count += CheckArr(nc_newton.passive_branch_data.x, nc_gc.passive_branch_data.X, tol, 'BranchData', 'x')
    err_count += CheckArr(nc_newton.passive_branch_data.g, nc_gc.passive_branch_data.G, tol, 'BranchData', 'g')
    err_count += CheckArr(nc_newton.passive_branch_data.b, nc_gc.passive_branch_data.B, tol, 'BranchData', 'b')
    err_count += CheckArr(nc_newton.passive_branch_data.rates, nc_gc.passive_branch_data.rates, tol, 'BranchData', 'rates')
    err_count += CheckArr(nc_newton.passive_branch_data.tap_module, nc_gc.passive_branch_data.tap_module, tol, 'BranchData', 'tap_module')
    err_count += CheckArr(nc_newton.passive_branch_data.tap_angle, nc_gc.passive_branch_data.tap_angle, tol, 'BranchData', 'tap_angle')

    err_count += CheckArr(nc_newton.passive_branch_data.g0, nc_gc.passive_branch_data.G0, tol, 'BranchData', 'g0')
    err_count += CheckArr(nc_newton.passive_branch_data.G0sw, nc_gc.passive_branch_data.G0sw, tol, 'BranchData', 'G0sw')
    err_count += CheckArr(nc_newton.passive_branch_data.k, nc_gc.passive_branch_data.k, tol, 'BranchData', 'k')
    err_count += CheckArr(nc_newton.passive_branch_data.beq, nc_gc.passive_branch_data.Beq, tol, 'BranchData', 'beq')
    err_count += CheckArr(nc_newton.passive_branch_data.alpha1, nc_gc.passive_branch_data.alpha1, tol, 'BranchData', 'alpha1')
    err_count += CheckArr(nc_newton.passive_branch_data.alpha2, nc_gc.passive_branch_data.alpha2, tol, 'BranchData', 'alpha2')
    err_count += CheckArr(nc_newton.passive_branch_data.alpha3, nc_gc.passive_branch_data.alpha3, tol, 'BranchData', 'alpha3')
    err_count += CheckArr(nc_newton.passive_branch_data.vtap_f, nc_gc.passive_branch_data.virtual_tap_f, tol, 'BranchData', 'vtap_f')
    err_count += CheckArr(nc_newton.passive_branch_data.vtap_t, nc_gc.passive_branch_data.virtual_tap_t, tol, 'BranchData', 'vtap_t')
    ...
    err_count += CheckArr(nc_newton.shunt_data.S, nc_gc.shunt_data.Y, tol, 'ShuntData', 'S')
