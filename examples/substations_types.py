...
subs_centelles = substation_wizards.double_bar(name='Centelles', grid=grid, n_lines=2, n_trafos=2, v_nom=220,
                                               lat=41.797790, lon=2.219917, country=country, include_disconnectors=False)
